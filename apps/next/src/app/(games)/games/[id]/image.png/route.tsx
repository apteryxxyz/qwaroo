...
import { Badge, BadgeRow } from '@/components/og/badge';
import { Branding } from '@/components/og/branding';
import { Card } from '@/components/og/card';
import { compactNumber } from '@/utilities/formatters';

function loadFont(name: string) {
  const path = `../../../../../../../public/fonts/${name}.ttf`;
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              {compactNumber(game.score.totalPlays)}
            </div>
          </div>
        </div>
      </div>
