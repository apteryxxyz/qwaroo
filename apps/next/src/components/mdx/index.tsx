...
const components = {
  h1: ({ className, children, ...props }: Props) => (
    <h1
      className={cn(
  ...
  h2: ({ className, children, ...props }: Props) => (
    <h2
      className={cn(
  ...
  h3: ({ className, children, ...props }: Props) => (
    <h3
      className={cn(
  ...
  h4: ({ className, children, ...props }: Props) => (
    <h4
      className={cn(
  ...
  h5: ({ className, children, ...props }: Props) => (
    <h5
      className={cn(
  ...
  h6: ({ className, children, ...props }: Props) => (
    <h6
      className={cn(
  ...
  a: ({ className, children, ...props }: Props) => (
    <a
...
export function Mdx({ code }: MdxProps) {
  ...
  return (
    <div className="mdx">
      {/* @ts-expect-error - Image not assignable */}
