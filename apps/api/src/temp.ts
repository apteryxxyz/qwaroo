...
export default async () => {
    ...
    await Game.create({
        ...
        thumbnailUrl:
            'https://hips.hearstapps.com/digitalspyuk.cdnds.net/13/33/640x640/square_gaming-grand-theft-auto-5-screenshot-1.jpg',
    ...
    await Game.create({
        slug: 'darkviper-views',
        type: 'higher-or-lower',
        title: 'DarkViperAU Views',
        shortDescription: 'Which DarkViperAU video has more views?',
